...
//                            // - 0: Full speed, 12Mbps.
//                            // - 1: Low speed, 1.5Mbps.
// #define bUC_DEV_PU_EN 0x20 // USB device enable and internal pull-up resistor control bit:
//                            // - 1: USB device transfer enabled and the internal pull-up resistor enabled.
// #define bUC_SYS_CTRL1 0x20 // USB system control high bit.
// #define bUC_SYS_CTRL0 0x10 // USB system control low bit.
// #define bUC_INT_BUSY  0x08 // Auto pause enable bit before the USB transfer completed interrupt flag is not reset:
//                            // - 1: It automatically pauses and responds to busy NAK before the UIF_TRANSFER interrupt flag is reset.
//                            // - 0: Not pause.
// #define bUC_RESET_SIE 0x04 // USB protocol processor software reset control bit:
//                            // - 1: Forcefully reset the USB protocol processor and most of the USB control registers, requires software to reset.
// #define bUC_CLR_ALL   0x02 // 1: Empty USB interrupt flag and FIFO, requires software to reset.
// #define bUC_DMA_EN    0x01 // 1: USB DMA and DMA interrupt enabled. 0: Disabled.
